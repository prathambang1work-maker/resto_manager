...
import { getDashboardStats, subscribeToTable } from '../utils/storage'
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const unsubKitchens = subscribeToTable('kitchens', refresh)
    return () => {
      unsubOrders()
      unsubKitchens()
    }
    ...
    <div className="flex flex-col gap-6">
      <header>
        ...
        <p className="mt-1 text-sm text-paper/60">
          A live read on order volume and kitchen load — updates automatically as orders come in.
        </p>
      </header>
